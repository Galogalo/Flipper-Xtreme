...
const WifideautherItem MenuItems[NUM_MENU_ITEMS] = {
    ...
    {"Stop", {""}, 1, {"Stop"}, NO_ARGS, FOCUS_CONSOLE_END, NO_TIP},
    {"Start", {""}, 1, {"Guided tour"}, NO_ARGS, FOCUS_CONSOLE_END, NO_TIP},
    {"Scan",
     {"All", "SSIDs", "Stations"},
     3,
     {"scan", "scan -m ap", "scan -m st"},
     NO_ARGS,
     FOCUS_CONSOLE_END,
     NO_TIP},
    {"Results",
     {"All", "SSIDs", "Stations"},
     3,
     {"results", "results -t ap", "results -t st"},
     INPUT_ARGS,
     FOCUS_CONSOLE_END,
     NO_TIP},
    {"Beacon", {"Fill name SSID"}, 1, {"beacon -ssid MyAps"}, INPUT_ARGS, FOCUS_CONSOLE_END, NO_TIP},
    {"Deauth",
     {"APs", "Station"},
     2,
     {"deauth -ap ", "deauth -st "},
     ...
     FOCUS_CONSOLE_END,
     NO_TIP},
    {"Probe", {"SSIDs"}, 1, {"probe -ssid "}, INPUT_ARGS, FOCUS_CONSOLE_END, NO_TIP},
    {"Ram", {"Print memory Usage"}, 1, {"ram"}, NO_ARGS, FOCUS_CONSOLE_END, NO_TIP},
